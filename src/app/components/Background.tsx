...
export default function Background() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      {/* Radial vignette */}
      <div className="absolute inset-0 bg-[radial-gradient(1200px_circle_at_50%_-10%,rgba(99,102,241,0.18),transparent_60%),radial-gradient(800px_600px_at_90%_10%,rgba(56,189,248,0.12),transparent_60%),radial-gradient(700px_500px_at_10%_80%,rgba(34,197,94,0.10),transparent_60%)]" />
      {/* Subtle grain */}
      ...
      {/* Soft edge vignette */}
      <div className="absolute inset-0 [mask-image:radial-gradient(70%_60%_at_50%_40%,black,transparent)] bg-black" />
    </div>
  );
}